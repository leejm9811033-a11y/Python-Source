...
# 파이썬 세션(session)은 웹에서 사용자 정보를 서버에 저장하는 기능을 말함.(쿠키를 통해 세션)
...
# 참고 키갑 자동생성 터미널창 > python -c "import secrets; print(secrets.token_hex(32))"
# 1165e8243bea7c10f3dc7606d72b29b847d500f73a1ed6e54ef020bce6030379
...
def setos():
    ...
    if favorite_os:
        session.permanent = True    # 세션 만료 기간 적용
