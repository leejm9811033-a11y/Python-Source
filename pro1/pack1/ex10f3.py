...
if showGugu(start = 7, end = 9) == showGugu(end = 9, start = 7):
    print( "맞아요.")
...
# def func2(*a, ar): # TypeError: func2() missing 1 required keyword-only argument: 'ar'
def func2(a, *ar):
    print(a)
    print(ar)
...
# func3(80, 180, {irum = "신기루", nai = 23}) # SyntaxError: invalid syntax. Maybe you meant '==' or ':=' instead of '='?
